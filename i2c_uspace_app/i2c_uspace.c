...
{
	int i2c_dev_node = 0;
	int i2c_dev_address = 0x53;  /* ADXL345 Device Address */
	int i2c_dev_reg_addr = 0x2D; /* ADXL345 POWER_CTL Register */
	char i2c_dev_node_path[] = "/dev/i2c-4"; /* ADXL345 Adapter Device Node*/
	unsigned short  i2c_val_to_write = 0x8;
	int ret_val = 0;
	__s32 read_value = 0;
	int i2c_dev_reg_x_acc = 0x32; /* ADXL345 X Measurement Register */
